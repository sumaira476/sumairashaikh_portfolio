        ...
        <div className="exp__container container grid">
            <div className="exp__content">
                <div>
                    ...
                    <h3 className="exp__title">Web Developer<br /> Developer </h3>
                </div>

                <div>
                    <span className="exp__comp">Unihawk Dubai</span>
                </div>
                ...
                <div className={toggleState === 1 ? "exp__modal active-modal" : "exp__modal"}>
                    <div className="exp__modal-content">
                        ...
                        <ul className="exp__modal-experiences grid">
                            ...
                            <li className="exp__modal-experience">
                                <li className="uil uil-check-circle exp__modal-icon"></li>
                                <p className="exp__modal-info">Created Wordpress plugin</p>
                            </li>

                            <li className="exp__modal-experience">
                                <li className="uil uil-check-circle exp__modal-icon"></li>
                                <p className="exp__modal-info">Developed and maintained a user trackinf tool for their website.</p>
                            </li>
