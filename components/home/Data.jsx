...
const Data = () => {
  ...
  const originalText = "Sumaira Shaikh";
  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">What started as curiosity became a craft, I love turning challenges into creative, functional code that keeps evolving with me.</p>

      <a href="https://cal.com/sumairashaikh" className="button button--flex">
        Say Hello
        <svg
